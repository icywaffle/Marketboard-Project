...
func jsontoarray(newarray []string, anystruct interface{}) {
...
func GetRecipe(itemjson string) {
	...
	jsontoarray(newarray, amount)
	fmt.Println(amount)

	/*
		var itemingrID ItemIngredient
		json.Unmarshal(byteValue, &itemingrID)
		jsontoarray(newarray, itemingrID)
		fmt.Println(itemingrID)
	*/
	//TODO: Deal with one Array, with an array of elements
